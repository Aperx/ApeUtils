package com.github.apeutils.Packets;
...
public class PacketUtils {
  public static final int ENTITY_ID = 1234;
	...
	public static void displayTextBar(String text, final Player player){
		...
		}.runTaskLater(ApeUtils.getInstance(), 120L);
	}
		...
		new BukkitRunnable(){
			...
			public void run(){
				if((loadUp ? health < 300 : health > 0)){
					...
					}.runTaskLater(ApeUtils.getInstance(), 40L);
					
					this.cancel();
				}
			}
		}.runTaskTimer(ApeUtils.getInstance(), delay, delay);
	}
